 ...
 * @ast node
 * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/java.ast:203
 */
public abstract class Case extends Stmt implements Cloneable {
   ...
   * @ast method 
   * @aspect Statements
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddExtensions/JimpleBackend/Statements.jrag:109
   */
   ...
   * @attribute syn
   * @aspect NameCheck
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/NameCheck.jrag:431
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect DA
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:570
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect DA
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:574
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect DU
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:1025
   */
   ...
   * @attribute syn
   * @aspect DU
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:1029
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/UnreachableStatements.jrag:83
   */
   ...
   * @attribute syn
   * @aspect Statements
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddExtensions/JimpleBackend/Statements.jrag:107
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java7Frontend/StringsInSwitch.jrag:38
   */
   ...
   * @attribute inh
   * @aspect NameCheck
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/NameCheck.jrag:417
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect TypeCheck
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/TypeCheck.jrag:358
   */
  @SuppressWarnings({"unchecked", "cast"})
