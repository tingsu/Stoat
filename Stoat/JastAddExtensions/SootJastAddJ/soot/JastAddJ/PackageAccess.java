 ...
 * @ast node
 * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/java.ast:29
 */
public class PackageAccess extends Access implements Cloneable {
   ...
   * @ast method 
   * @aspect NameCheck
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/NameCheck.jrag:50
   */
   ...
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/NodeConstructors.jrag:18
   */
   ...
   * @ast method 
   * @aspect PrettyPrint
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:510
   */
   ...
   * @attribute syn
   * @aspect Names
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/QualifiedNames.jrag:23
   */
  public String name() {
    ASTNode$State state = state();
   ...
   * @attribute inh
   * @aspect NameCheck
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/NameCheck.jrag:243
   */
  @SuppressWarnings({"unchecked", "cast"})
