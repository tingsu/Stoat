 ...
 * @ast node
 * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/java.ast:150
 */
public abstract class Binary extends Expr implements Cloneable {
   ...
   * @ast method 
   * @aspect PrettyPrint
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:394
   */
   ...
   * @ast method 
   * @aspect Expressions
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddExtensions/JimpleBackend/Expressions.jrag:772
   */
   ...
   * @ast method 
   * @aspect Expressions
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddExtensions/JimpleBackend/Expressions.jrag:785
   */
   ...
   * @ast method 
   * @aspect Expressions
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddExtensions/JimpleBackend/Expressions.jrag:802
   */
   ...
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java7Frontend/ConstantExpression.jrag:370
   */
  private TypeDecl refined_ConstantExpression_Binary_binaryNumericPromotedType()
{
   ...
   * @attribute syn
   * @aspect PrettyPrint
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:400
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect ConstantExpression
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java7Frontend/ConstantExpression.jrag:345
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect ConstantExpression
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java7Frontend/ConstantExpression.jrag:368
   */
  public Expr left() {
    ASTNode$State state = state();
   ...
   * @attribute syn
   * @aspect ConstantExpression
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java7Frontend/ConstantExpression.jrag:369
   */
  public Expr right() {
    ASTNode$State state = state();
   ...
   * @attribute syn
   * @aspect DA
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:401
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect DA
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:402
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect DA
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:404
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect DU
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:845
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect DU
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:696
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  /**
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:405
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:846
   * @apilevel internal
   */
