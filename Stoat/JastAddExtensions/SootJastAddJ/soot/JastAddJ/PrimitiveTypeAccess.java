 ...
 * @ast node
 * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/java.ast:24
 */
public class PrimitiveTypeAccess extends TypeAccess implements Cloneable {
   ...
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/LookupType.jrag:234
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn nta
   * @aspect TypeScopePropagation
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/LookupType.jrag:235
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn nta
   * @aspect TypeScopePropagation
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/LookupType.jrag:236
   */
  @SuppressWarnings({"unchecked", "cast"})
  public String getID() {
    if(getID_computed) {
