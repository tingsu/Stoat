 ...
 * @ast node
 * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/java.ast:25
 */
public class ArrayTypeAccess extends TypeAccess implements Cloneable {
   ...
   * @ast method 
   * @aspect NameCheck
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/NameCheck.jrag:155
   */
   ...
   * @ast method 
   * @aspect PrettyPrint
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:490
   */
   ...
   * @ast method 
   * @aspect Expressions
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddExtensions/JimpleBackend/Expressions.jrag:660
   */
   ...
   * @attribute syn nta
   * @aspect Arrays
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/Arrays.jrag:56
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn nta
   * @aspect Arrays
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/Arrays.jrag:57
   */
  @SuppressWarnings({"unchecked", "cast"})
  public String getID() {
    if(getID_computed) {
   ...
   * @declaredat /home/ting/workspace/MyAndroidAnalysis/src/JastAddJ/Java1.4Frontend/LookupType.jrag:246
   */
  @SuppressWarnings({"unchecked", "cast"})
